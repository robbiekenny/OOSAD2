...
public class OrmodelPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Ormodel";
	...
	private OrmodelPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new OrmodelPersistentManager();
		}
