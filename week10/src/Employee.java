...
public class Employee {
	...
	public static Employee loadEmployeeByORMID(int id) throws PersistentException {
		try {
			PersistentSession session = OrmodelPersistentManager.instance().getSession();
	...
	public static Employee loadEmployeeByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Employee) session.load(Employee.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Employee loadEmployeeByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Employee) session.load(Employee.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Employee getEmployeeByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Employee) session.get(Employee.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public boolean save() throws PersistentException {
		try {
			OrmodelPersistentManager.instance().saveObject(this);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean delete() throws PersistentException {
		try {
			OrmodelPersistentManager.instance().deleteObject(this);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean refresh() throws PersistentException {
		try {
			OrmodelPersistentManager.instance().getSession().refresh(this);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean evict() throws PersistentException {
		try {
			OrmodelPersistentManager.instance().getSession().evict(this);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
